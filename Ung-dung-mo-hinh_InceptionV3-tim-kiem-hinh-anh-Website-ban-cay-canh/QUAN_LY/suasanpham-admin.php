<?php
    ...
    $sql3 = "SELECT * FROM HINH_ANH WHERE ma_san_pham = {$id}";
    $result3 = mysqli_fetch_assoc(mysqli_query($connect,$sql3));
    ...
    if(isset($_POST['submit'])){
        ...
        `ma_loai`='$maloai',`ten_san_pham`='$tensanpham',`gia_tien`='$giatien',`kich_thuoc`='$kichthuoc',`so_luong`='$soluong',`dac_diem`='$dacdiem',`cong_dung`='$congdung' WHERE ma_san_pham = $masanpham";
        ...
        if(isset($_FILES["photo"]) && $_FILES["photo"]["error"] == 0){
            ...
            if(in_array($filetype, $allowed)){
                ...
                $sql4 = "UPDATE HINH_ANH SET ten_hinh = '$filename' WHERE ma_san_pham = {$id}";
...
<body>
    ...
    <div class="container-fluid">
        ...
        <h4 class="text-center fs-2 mt-5" style="color:green">CẬP NHẬT THÔNG TIN</h4>
                ...
                <table class="table table-success">
                    ...
                    <tbody>
                                ...
                                <div class="mb-3">
                                    <select name="ma_loai" class="form-select form-select-sm"
                                        ...
                                        <option value="<?php echo $value['ma_loai'] ?>">
                                            <?php if($value['ma_loai'] == $result['ma_loai']){
                                                    echo "-";}    
                                                    echo $value['ten_loai'];
                                        ?>
                                        </option>
                            ...
                            <td>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="gia_tien"
                                        aria-label="Amount (to the nearest dollar)" value="<?= $result['gia_tien'] ?>">
                            ...
                            <td>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="so_luong" placeholder="" aria-label=""
                                        aria-describedby="basic-addon1" value="<?=$result['so_luong']?>">
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    $folder = $result['ten_san_pham'];
                                    $folder = convert_name($folder) ;
                                    // $folder_path = strtolower(substr($folder, 0, -1));
                                ?>
                                <img src="./upload_image/<?=$folder."/".$result3['ten_hinh']?>.jpg" style="width: 200px;height: 200px;" class="img-thumbnail">
                        ...
                        <tr>
                            ...
                            <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="video_mota" placeholder="" aria-label=""
                                        aria-describedby="basic-addon1" value="<?=$result3['video_mota']?>">
                                </div>
                            </td>
                        </tr>
                    </tbody>
