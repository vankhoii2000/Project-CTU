<?php
    ...
    WHERE DH.ma_khach_hang = KH.ma_khach_hang and TT.ma_don_hang = DH.ma_don_hang and TT.trang_thai = 1";
...
<body>
    <div class="container-fluid">
        ...
        <h4 class="text-center fs-2 mt-5" style="color:green">DANH SÁCH ĐƠN HÀNG ĐÃ XÁC NHẬN</h4>
            ...
            <table class="table table-success">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="chitietdxl.php?id=<?=$value['ma_don_hang']?>" type="button" class="btn btn-primary">Chi tiết</a></td>
                    <tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
